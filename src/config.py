...
norm_mapping_wrf = {
    "aldif": {"mean": 0.16539352, "scale": 0.03575806},
...
norm_mapping_standard = {
    "aldif": {"mean": 0.0, "scale": 1.0, "count": 5.0},
...
norm_mapping_wrf07 = {
    "aldif": {"mean": 1.2225e-01, "scale": 9.6926e-02 * 1.4142, "count": 5.0},
    ...
    "sicefrac": {"mean": 0.0000e00, "scale": 0.1 * 1.4142, "count": 5.0},
    "snow": {"mean": 1.6870e00, "scale": 4.2675e00 * 1.4142, "count": 5.0},
    "solc": {"mean": 1.0953e03, "scale": 3.8823e02 * 1.4142, "count": 5.0},
    "tsfc": {"mean": 2.8127e02, "scale": 1.0318e01 * 1.4142, "count": 5.0},
    ...
    "play": {"mean": 4.0791e02, "scale": 2.1855e02 * 1.4142, "count": 5.0},
    ...
    "tlay": {"mean": 2.4465e02, "scale": 1.9199e01 * 1.4142, "count": 5.0},
...
norm_mapping_small = {
    "aldif": {"mean": 0.07733402495029901, "scale": 0.14426375905340982},
    "aldir": {"mean": 0.07733402495029901, "scale": 0.14426375905340982},
    "asdif": {"mean": 0.07733402495029901, "scale": 0.14426375905340982},
    "asdir": {"mean": 0.07733402495029901, "scale": 0.14426375905340982},
    "cosz": {"mean": 0.24990819984045695, "scale": 0.32281969941008914},
    "landfrac": {"mean": 0.32718219097832457, "scale": 0.46918440392339117},
    "sicefrac": {"mean": 0.04987251948864919, "scale": 0.21349805289282955},
    "snow": {"mean": 7.069139775059871, "scale": 35.37339154698258},
    "solc": {"mean": 675.449573007544, "scale": 675.4495769588103},
    "tsfc": {"mean": 290.0060671896639, "scale": 16.10186250706953},
    "emiss": {"mean": 0.9690415807189793, "scale": 0.020907886121743838},
    "ccl4vmr": {"mean": 9.300000000001259e-11, "scale": 1.258865494729139e-23},
    "cfc11vmr": {"mean": 2.510000000000007e-10, "scale": 6.72084247699335e-25},
    "cfc12vmr": {"mean": 5.380000000000207e-10, "scale": 2.0679515313825692e-23},
    "cfc22vmr": {"mean": 1.6900000000000588e-10, "scale": 5.86781247029804e-24},
    "ch4vmr": {"mean": 1.7740000000000964e-06, "scale": 9.634999775017666e-20},
    "cldfrac": {"mean": 0.06486385190002748, "scale": 0.23221686982110262},
    "co2vmr": {"mean": 0.0003789999999999624, "scale": 3.7621815385247004e-17},
    "n2ovmr": {"mean": 3.189999999999797e-07, "scale": 2.0275851174899814e-20},
    "o2vmr": {"mean": 0.20948799999998594, "scale": 1.4072076837123859e-14},
    "o3vmr": {"mean": 1.3086193771823524e-06, "scale": 2.497903860241533e-06},
    "play": {"mean": 433.2784715674021, "scale": 349.3829250302278},
    "qc": {"mean": 3.4734579541537886e-06, "scale": 3.651619090712969e-05},
    "qg": {"mean": 3.95572240963548e-08, "scale": 9.658252160810546e-07},
    "qi": {"mean": 1.7342309114125204e-06, "scale": 1.1041621699839175e-05},
    "qr": {"mean": 5.015872804306918e-07, "scale": 6.8198588982021956e-06},
    "qs": {"mean": 7.422841587584547e-07, "scale": 1.1291736630083783e-05},
    "qv": {"mean": 0.0027685824123561964, "scale": 0.004541676652300635},
    "tlay": {"mean": 247.3522624502228, "scale": 31.882175499563953},
    "swuflx": {"mean": 65.83682248182676, "scale": 114.08526662989976},
    "swdflx": {"mean": 284.93779325031517, "scale": 385.9458926558632},
    "lwuflx": {"mean": 307.30982851987466, "scale": 79.95097341102883},
    "lwdflx": {"mean": 133.37528868602683, "scale": 131.91846491811287},
    "swhr": {"mean": -5.000000000000174e19, "scale": 5.000000000000146e19},
    "lwhr": {"mean": -1.4600210926449122, "scale": 2.9646242136340737},
}
...
norm_mapping = {
    "aldif": {"mean": 0.07628345257879962, "scale": 0.14555045910111844},
...
norm_mapping_fullyear = {
    "aldif": {"mean": 0.07696025877812071, "scale": 0.15143388863539975, "count": 5.0},
    "aldir": {"mean": 0.07696025877812071, "scale": 0.15143388863539975, "count": 5.0},
    ...
    "landfrac": {
        "mean": 0.2789158589203377,
        "scale": 0.48141504378953337,
        "count": 5.0,
    },
    "sicefrac": {
        "mean": 0.024454165799585204,
        "scale": 0.15066591539970534,
        "count": 5.0,
    },
    ...
    "ccl4vmr": {
        "mean": 9.300000000002044e-11,
        "scale": 2.0683651216888453e-23,
        "count": 5.0,
    },
    "cfc11vmr": {
        "mean": 2.509999999999694e-10,
        "scale": 3.3054137277618987e-23,
        "count": 5.0,
    },
    "cfc12vmr": {
        "mean": 5.380000000000145e-10,
        "scale": 1.9248492854108954e-23,
        "count": 5.0,
    },
    "cfc22vmr": {
        "mean": 1.689999999999571e-10,
        "scale": 4.719168792191592e-23,
        "count": 5.0,
    },
    "ch4vmr": {
        "mean": 1.7739999999997727e-06,
        "scale": 2.511622095198451e-19,
        "count": 5.0,
    },
    "cldfrac": {
        "mean": 0.052887799932715106,
        "scale": 0.21280771797915113,
        "count": 5.0,
    },
    "co2vmr": {
        "mean": 0.00037899999999993587,
        "scale": 6.903115232215206e-17,
        "count": 5.0,
    },
    "n2ovmr": {
        "mean": 3.1900000000004313e-07,
        "scale": 4.6303056061656333e-20,
        "count": 5.0,
    },
    "o2vmr": {
        "mean": 0.2094879999999765,
        "scale": 2.5428548156014588e-14,
        "count": 5.0,
    },
    "o3vmr": {
        "mean": 1.3093404493784795e-06,
        "scale": 2.508586197157427e-06,
        "count": 5.0,
    },
    ...
    "qi": {
        "mean": 1.6059618222480042e-06,
        "scale": 1.0793740974679207e-05,
        "count": 5.0,
    },
    "qr": {"mean": 5.545863663084633e-07, "scale": 7.369434583515737e-06, "count": 5.0},
    "qs": {
        "mean": 8.842259495156865e-07,
        "scale": 1.3718948913066267e-05,
        "count": 5.0,
    },
...
norm_mapping_fullyear_new = {
    "aldif": {"mean": 0.08286888152360916, "scale": 0.15738269686698914},
...
climart_96_feature_mean = torch.tensor(
    [
        2.2001e-01,
        2.7896e02,
        9.6671e04,
...
climart_96_feature_std = torch.tensor(
    [
        2.2635e-01,
        6.3000e00,
        4.9265e03,
...
climart_96_target_mean = torch.tensor([53.4817, 267.9034, 280.4040, 93.5093]).unsqueeze(
    -1
)
