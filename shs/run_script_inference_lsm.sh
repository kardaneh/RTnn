...
beta_str=${beta//./d}
main_folder="Prod__LSTM_64_2_bs_16_tb_1_nw_16_ep_150"
sub_folder="lr_0d001_beta_0d001_lf_nmse_date_20250625_023855"
prefix="$sub_folder"
...
python src/inference_lsm.py \
    ...
    --load_model "True"\
    --load_checkpoint_name "lr_0d001_beta_0d001_lf_nmse_date_20250625_0238550149model.pth.tar"
