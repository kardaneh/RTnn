#!/bin/bash
echo "Time = 20250630_234128"
echo "Running training with model: LSTM_64_2, loss: nmse"

python src/main_lsm.py \
    --root_dir "./" \
    --main_folder "Prod__LSTM_64_2_Sblock_64_Tblock_1_Nworkers_4_Nepochs_150" \
    --sub_folder "Norm_log1p_standard_Lrate_0d001_beta_0d001_Loss_nmse_date_20250630_234128" \
    ...
    --train_year "1998" \
    --test_year "1999" \
    --prefix "Norm_log1p_standard_Lrate_0d001_beta_0d001_Loss_nmse_date_20250630_234128" \
    --dataset_type "LSM" \
    --loss_type "nmse" \
    --learning_rate "0.001" \
    --beta "0.001" \
